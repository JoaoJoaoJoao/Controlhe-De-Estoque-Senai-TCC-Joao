...
//        fornecedor.setValorProduto(Double.parseDouble(txtValorSaida.getText()));
//
//        if (fornecedor.getIdFornecedor()== null) {
//
//            JOptionPane.showMessageDialog(null, produtoController.insert(fornecedor, categoriaProdutos.getIdCategoriaGrupoProdutos()));
//            this.dispose();
//            // Senão altera os dados do ID já existente
//        } else {
//
//            fornecedor.setNomeProduto(txtNome.getText());
//            fornecedor.setCustoProduto(Double.parseDouble(txtValorCusto.getText()));
//            fornecedor.setEstoqueIdeal(Integer.parseInt(txtEstoqueAtual.getText()));
//            fornecedor.setEstoqueMin(Integer.parseInt(txtEstoqueMin.getText()));
//            fornecedor.setValorProduto(Double.parseDouble(txtValorSaida.getText()));
//
//            JOptionPane.showMessageDialog(rootPane, produtoController.update(fornecedor));
//            this.dispose();
//        }
//
//        limpaTela();

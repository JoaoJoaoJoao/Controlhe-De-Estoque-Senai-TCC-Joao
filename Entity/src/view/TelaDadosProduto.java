...
public class TelaDadosProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Custo do Produto");
...
tl.setVisible(true);
   ...
   private void atualizaDados (Produto produto){
       
       jLabel1.setText(produto.getNomeProduto());
       jLabel2.setText(produto.getCategoria());
       jLabel3.setText(produto.getCustoProduto()+"");
       jLabel4.setText(produto.getValorProduto()+"");
       jLabel5.setText(produto.getEstoqueIdeal()+"");

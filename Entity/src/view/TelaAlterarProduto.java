...
public class TelaAlterarProduto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (produto.getEstoqueIdeal() < produto.getEstoqueMin()) {
            JOptionPane.showMessageDialog(null, produto.VerificaQuantidade(produto.getEstoqueIdeal(), produto.getEstoqueMin()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaAlterarProduto tl = new TelaAlterarProduto(null);
                tl.setVisible(true);
            }
        });
    }
